...
public final class UserDao_Impl implements UserDao {
  ...
  public UserDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfUserEntity = new EntityInsertionAdapter<UserEntity>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR ABORT INTO `users` (`id`,`name`,`role`,`roll`,`pin`) VALUES (nullif(?, 0),?,?,?,?)";
      }
      ...
      protected void bind(@NonNull final SupportSQLiteStatement statement,
        ...
        if (entity.getRoll() == null) {
          statement.bindNull(4);
        } else {
          statement.bindString(4, entity.getRoll());
        }
  ...
  @Override
  public Object findStudentByCredentials(final String name, final String roll, final String pin,
      ...
      public UserEntity call() throws Exception {
        ...
        try {
          ...
          if (_cursor.moveToFirst()) {
            ...
            final String _tmpRoll;
            if (_cursor.isNull(_cursorIndexOfRoll)) {
              _tmpRoll = null;
            } else {
              _tmpRoll = _cursor.getString(_cursorIndexOfRoll);
            }
            final String _tmpPin;
            _tmpPin = _cursor.getString(_cursorIndexOfPin);
            _result = new UserEntity(_tmpId,_tmpName,_tmpRole,_tmpRoll,_tmpPin);
          } else {
            _result = null;
          }
          return _result;
  ...
  @Override
  public Object studentRollExists(final String roll,
      final Continuation<? super Boolean> $completion) {
    final String _sql = "SELECT EXISTS(SELECT 1 FROM users WHERE roll = ? AND role = 'student')";
  ...
  @Override
  public Flow<List<UserEntity>> observeStudents() {
    final String _sql = "SELECT * FROM users WHERE role = 'student' ORDER BY name ASC";
      ...
      public List<UserEntity> call() throws Exception {
        ...
        try {
          ...
          while (_cursor.moveToNext()) {
            ...
            final String _tmpPin;
            _tmpPin = _cursor.getString(_cursorIndexOfPin);
            _item = new UserEntity(_tmpId,_tmpName,_tmpRole,_tmpRoll,_tmpPin);
            _result.add(_item);
          }
          return _result;
        } finally {
